  ...
  return (
    <>
      <main id="content" role="main" class="w-full  max-w-md mx-auto p-1">
        <div class="md:mt-[10rem] bg-white  rounded-xl shadow-lg dark:bg-gray-800 dark:border-gray-700 border-2 border-indigo-300">
                ...
                <div class="grid gap-y-4">
                  <div>
                    ...
                    <div class="relative">
                      ...
                      {!regex.test(input.email) && input.email && (
                        <p className="text-red-500 mt-1 text-sm">
                          {formErrors.email}
                        </p>
                      )}
                  ...
                  <button
                    type="submit"
                    class="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800 uppercase"
                  >
